                ...
                <div class="tab">
                    ...
                    <div class="tab-body tab-body-bordered">
                        <div id="tabUserLogin" class="tab-panel active">
                            <form id="formUserLogin" class="form-x" action="/account/login" method="post" novalidate="novalidate">
                                <div class="form-group">
                                    <div class="label">
                                        <label for="account">账号</label>
                                    </div>
                                    <div class="field">
                                        <input type="text" id="user_account" name="account" class="input" data-val="true" data-val-required="登录账号不能为空">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="label">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="field">
                                        <label class="i-check">
                                            <input type="checkbox" id="user_rember"><i></i>
                                            记住账号
                                        </label>
                                    </div>
                                </div>
